...
module FFI
  module CPL
    module Error
      ...
      attach_function :CPLDefaultErrorHandler, [enum_type(:CPLErr), :int, :string], :void
      attach_function :CPLEmergencyError, [], :void
      attach_function :CPLError, [enum_type(:CPLErr), :int, :string], :void
      attach_function :CPLErrorReset, [], :void
      attach_function :CPLErrorV, [enum_type(:CPLErr), :int, :string, :pointer], :void
      attach_function :CPLGetErrorHandlerUserData, [], :pointer
      attach_function :CPLGetLastErrorNo, [], :int
      attach_function :CPLGetLastErrorType, [], enum_type(:CPLErr)
      attach_function :CPLGetLastErrorMsg, [], :strptr

      attach_function :CPLLoggingErrorHandler, [enum_type(:CPLErr), :int, :string], :void
      ...
      attach_function :CPLQuietErrorHandler, [enum_type(:CPLErr), :int, :string], :void
