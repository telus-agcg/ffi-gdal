...
module GDAL
  module ColorTableTypes
    ...
    autoload :CMYK, autoload_path('color_table_types/cmyk')
    autoload :Gray, autoload_path('color_table_types/gray')
    autoload :HLS, autoload_path('color_table_types/hls')
    autoload :RGB, File.expand_path('color_table_types/rgb')
  end
