...
module OGR
  class FeatureDefinition
    ...
    def initialize(name_or_pointer)
      ...
      close_me = -> { FFI::OGR::API.OGR_FD_Destroy(@feature_definition_pointer) }
    ...
    def release!
      FFI::OGR::API.OGR_FD_Release(@feature_definition_pointer)
    end

    # @return [String]
    def name
      FFI::OGR::API.OGR_FD_GetName(@feature_definition_pointer)
    end
    ...
    def field_index(name)
      result = FFI::OGR::API.OGR_FD_GetFieldIndex(@feature_definition_pointer, name)
    ...
    def geometry_type
      FFI::OGR::API.OGR_FD_GetGeomType(@feature_definition_pointer)
    end

    # @param new_type [FFI::OGR::API::WKBGeometryType]
    def geometry_type=(new_type)
      FFI::OGR::API.OGR_FD_SetGeomType(@feature_definition_pointer, new_type)
    end

    # @return [Boolean]
    def geometry_ignored?
      FFI::OGR::API.OGR_FD_IsGeometryIgnored(@feature_definition_pointer)
    end

    # @param ignore [Boolean]
    def ignore_geometry!(ignore = true)
      FFI::OGR::API.OGR_FD_SetGeometryIgnored(@feature_definition_pointer, ignore)
    end

    # @return [Boolean]
    def style_ignored?
      FFI::OGR::API.OGR_FD_IsStyleIgnored(@feature_definition_pointer)
    end

    # @param ignore [Boolean]
    def ignore_style!(ignore = true)
      FFI::OGR::API.OGR_FD_SetStyleIgnored(@feature_definition_pointer, ignore)
    end

    # @return [Fixnum]
    def geometry_field_count
      FFI::OGR::API.OGR_FD_GetGeomFieldCount(@feature_definition_pointer)
    end
    ...
    def geometry_field_index(name)
      result = FFI::OGR::API.OGR_FD_GetGeomFieldIndex(@feature_definition_pointer, name)
    ...
    def add_geometry_field_definition(geometry_field_definition)
      ...
      FFI::OGR::API.OGR_FD_AddGeomFieldDefn(@feature_definition_pointer,
        geometry_field_definition_ptr)
    end
    ...
    def delete_geometry_field_definition(index)
      ogr_err = FFI::OGR::API.OGR_FD_DeleteGeomFieldDefn(@feature_definition_pointer,
        index)
    ...
    def same?(other_feature_definition)
      ...
      FFI::OGR::API.OGR_FD_IsSame(@feature_definition_pointer, fd_ptr)
    end
  end
end
