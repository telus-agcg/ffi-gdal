...
#floyd.extract_ndvi('ndvi.tif', band_order: %i[nir red green blue], type: :GDT_Float32)
#floyd.extract_gndvi('gndvi.tif', band_order: %i[nir red green blue], type: :GDT_Float32)
